...
try:
    ...
    # Fallback import
    try:
        from code.run_toy_examples import PromptComposer
    except ImportError:
        print(f"Could not import {PromptComposer} from run_toy_examples or code.run_toy_examples")
...
try:
    ...
    # Fallback import
    try:
        from code.run_toy_examples import ScenarioTester
    except ImportError:
        print(f"Could not import {ScenarioTester} from run_toy_examples or code.run_toy_examples")
